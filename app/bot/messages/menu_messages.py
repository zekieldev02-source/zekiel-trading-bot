...
_CONFIG_HINTS: dict[str, str] = {
    "menu:ct:wallet": "✏️ To configure your tracked wallet, use the command /setwallet",
    "menu:ct:amount": "💰 To set your trade amount, use the command /setamount",
    "menu:ct:tp": "📊 To set your take-profit, use the command /settp",
    "menu:ct:mc": (
        "📉 To configure market caps:\n"
        "• Entry → /setentrymc\n"
        "• Exit → /setexitmc"
    ),
    "menu:settings:wallet": "✏️ To configure your tracked wallet, use the command /setwallet",
    "menu:settings:amount": "💰 To set your trade amount, use the command /setamount",
    "menu:settings:tp": "📈 To set your take-profit, use the command /settp",
    "menu:settings:sl": "🛑 To set your stop-loss, use the command /setstoploss",
    "menu:settings:entrymc": "📉 To set the max entry MC, use the command /setentrymc",
    "menu:settings:exitmc": "📈 To set the target exit MC, use the command /setexitmc",
}
